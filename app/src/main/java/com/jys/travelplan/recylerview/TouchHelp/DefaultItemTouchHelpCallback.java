...
public class DefaultItemTouchHelpCallback extends ItemTouchHelper.Callback {
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder srcViewHolder, RecyclerView.ViewHolder targetViewHolder) {
        if (onItemTouchCallbackListener != null) {
            return onItemTouchCallbackListener.onMove(recyclerView,srcViewHolder , targetViewHolder,srcViewHolder.getAdapterPosition(), targetViewHolder.getAdapterPosition());
        }
        return false;
    }

    /**
     * @param viewHolder    操作的viewHolder
     * @param direction     方向
     */
    @Override
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        if (onItemTouchCallbackListener != null) {
            onItemTouchCallbackListener.onSwiped(viewHolder,viewHolder.getAdapterPosition());
        }
    }
    ...
    public interface OnItemTouchCallbackListener {
         ...
         */
        boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder srcViewHolder, RecyclerView.ViewHolder targetViewHolder, int srcPosition, int targetPosition);
