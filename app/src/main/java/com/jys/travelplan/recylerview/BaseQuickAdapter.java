...
//    }
    ...
    //针对GridLayoutManager以及LinearLayoutManager的拖拽调序（其他Manager没有测试过）
    public void onItemMove(ViewHolder srcViewHolder, ViewHolder targetViewHolder, int fromPos, int toPos) {
        srcViewHolder.itemView.setTag(toPos);
        targetViewHolder.itemView.setTag(fromPos);
